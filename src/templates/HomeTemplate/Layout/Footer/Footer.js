...
export default function Footer(props) {
    ...
    return (
        <div>
            <footer className="px-4 divide-y dark:bg-gray-800 dark:text-gray-100 bg-gray-700 text-gray-300">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/4">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            ...
                            <div className="self-center text-2xl font-semibold">Partner</div>                      
                        </a>
                        <div className='grid grid-cols-3 gap-2'>
                        {arrHeThongRap.map((htr, index) =>{
                               return <img key={index} src={htr.logo} alt={htr.logo} className='w-10'/>
                            })}
                        </div> 
                    </div>
